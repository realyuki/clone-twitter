      ...
      <div>
        <div className="flex flex-row-reverse">
          <div className="flex min-w-[45vw]">
            <div className="flex w-[100%] min-w-437 max-w-760 items-center p-20">
              <div>
                ...
                <Link className="button bg-blue text-white" href="/i/flow/signup">
                  Create account
                </Link>
                <p className="mt-40 mb-20 font-bold text-md">Already have an account?</p>
          ...
          <div className="flex min-h-[45vh] flex-1 justify-center">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="h-[100%] max-h-380 w-[100%] fill-white p-32">
              <g>
