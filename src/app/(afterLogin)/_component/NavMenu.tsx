...
export default function NavMenu() {
  ...
  return (
    <>
      <li>
        <Link href="/home" className="flex h-[58px] flex-row items-center gap-[20px]">
          {segment === 'home' ? (
            <>
              <svg viewBox="0 0 24 24" aria-hidden="true" className="w-[1.75rem] fill-white">
                <g>
      ...
      <li>
        <Link href="/explore" className="flex h-[58px] flex-row items-center gap-[20px]">
      ...
      <li>
        <Link href="/messages" className="flex h-[58px] flex-row items-center gap-[20px]">
          {segment === 'messages' ? (
            <>
              <svg viewBox="0 0 24 24" aria-hidden="true" className="w-[1.75rem] fill-white">
                <g>
      ...
      {me?.user?.email && (
        <li>
          <Link href={`/${me?.user.email}`} className="flex h-[58px] flex-row items-center gap-[20px]">
